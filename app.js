...
veryOldInventors = inventors.filter((e) => {
  return e.year > 1499 && e.year < 1600
})
// Check your work:
...
// Complete the exercise in the space below:
inventorNamedAda = inventors.find((e) => {
  return e.first === "Ada"
})
// Check your work:
...
// Complete the exercise in the space below:
isAdultPresent = devs.some((e) => {
  const year = new Date()
  return (year.getFullYear() - e.year) >= 18
})
// Check your work:
...
// Complete the exercise in the space below:
isEveryone19OrOlder = devs.every((e) => {
  const obYear = new Date()
  return (obYear.getFullYear - e.year) >= 19
})
// Check your work:
